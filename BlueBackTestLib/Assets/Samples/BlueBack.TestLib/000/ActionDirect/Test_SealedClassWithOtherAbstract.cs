...
{
	/** Test_SealedClassWithOtherAbstract
	*/
	public sealed class Test_SealedClassWithOtherAbstract : BlueBack.TestLib.SpeedTest.Test_Base
	{
		/** action
		*/
		public Action_SealedClassWithOtherAbstract action;
		...
		*/
		...
		/** constructor
		*/
		public Test_SealedClassWithOtherAbstract()
		{
			//count
			this.count = 0;
		...
		*/
		...
		{
			//action
			this.action = new Action_SealedClassWithOtherAbstract();
