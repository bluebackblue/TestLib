...
{
	/** Test_SealedClassWithAbstract
	*/
	public sealed class Test_SealedClassWithAbstract : BlueBack.TestLib.SpeedTest.Test_Base
	{
		/** action
		*/
		public Action_SealedClassWithAbstract action;
		...
		*/
		...
		/** constructor
		*/
		public Test_SealedClassWithAbstract()
		{
			//count
			this.count = 0;
		...
		*/
		...
		{
			//action
			this.action = new Action_SealedClassWithAbstract();
