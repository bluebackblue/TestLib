...
namespace BlueBack.TestLib.Samples.ActionDirect
{
	/** Test_Static
	*/
	public sealed class Test_Static : BlueBack.TestLib.SpeedTest.Test_Base
	{
		/** action
		*/
		//public Action_Static action;
		...
		*/
		public void TestMain()
		{
			for(long ii=0;ii<Config.MAX;ii++){
				Action_Static.Do(ref this.result);
			}
		}
