...
namespace BlueBack.TestLib.Samples.ActionDirect
{
	/** Test_DefaultClass
	*/
	public sealed class Test_DefaultClass : BlueBack.TestLib.SpeedTest.Test_Base
	{
		/** action
		*/
		public Action_DefaultClass action;
		...
		*/
		...
		{
			//action
			this.action = new Action_DefaultClass();
