...
namespace BlueBack.TestLib.Samples.ActionDirect
{
	/** Test_SealedClass
	*/
	public sealed class Test_SealedClass : BlueBack.TestLib.SpeedTest.Test_Base
	{
		/** action
		*/
		public Action_SealedClass action;
		...
		*/
		...
		{
			//action
			this.action = new Action_SealedClass();
