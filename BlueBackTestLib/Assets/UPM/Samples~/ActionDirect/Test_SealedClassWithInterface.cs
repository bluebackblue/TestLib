...
{
	/** Test_SealedClassWithInterface
	*/
	public sealed class Test_SealedClassWithInterface : BlueBack.TestLib.SpeedTest.Test_Base
	{
		/** action
		*/
		public Action_SealedClassWithInterface action;
		...
		*/
		...
		/** constructor
		*/
		public Test_SealedClassWithInterface()
		{
			//count
			this.count = 0;
		...
		*/
		...
		{
			//action
			this.action = new Action_SealedClassWithInterface();
