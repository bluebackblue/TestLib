...
{
	/** Test_DefaultClassWithAbstract
	*/
	public sealed class Test_DefaultClassWithAbstract : BlueBack.TestLib.SpeedTest.Test_Base
	{
		/** action
		*/
		public Action_DefaultClassWithAbstract action;
		...
		*/
		...
		/** constructor
		*/
		public Test_DefaultClassWithAbstract()
		{
			//count
			this.count = 0;
		...
		*/
		...
		{
			//action
			this.action = new Action_DefaultClassWithAbstract();
